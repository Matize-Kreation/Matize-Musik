...
export default function HeroMatizeMusik() {
  // alle drei problematischen Assets einmal durch den Helper
  const bannerSrc = normalizePublicPath("/images/logos/banner_2560x1440.png");
  const freqSrc = normalizePublicPath("/images/textures/frequenz-800x200.png");
  const mixerSrc = normalizePublicPath("/images/textures/mischpult(8000x2122).png");
