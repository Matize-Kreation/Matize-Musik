...
export default function TrackPage() {
  const cover = normalizePublicPath("public/images/covers/facetten/tracks/12-apokalypse.jpg");
  const audio = normalizePublicPath("public/audio/facetten/12 - Apokalypse_(Master).mp3");
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[280px,1fr] items-start">
          <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-slate-700/40 bg-slate-900/30 shadow-[0_24px_55px_rgba(0,0,0,0.35)]">
            {cover ? (
              <Image src={cover} alt="Apokalypse" fill className="object-cover" priority />
            ) : (
