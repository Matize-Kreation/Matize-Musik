...
export const metadata = {
  title: "Perspektive | Matize-Musik",
};

export default function TrackPage() {
  const cover = normalizePublicPath(
    "D:\\Matize\\Matize-Kreation\\Matize-Musik\\public\\images\\covers\\facetten\\tracks\\03-perspektive.jpg"
  );
  const audio = normalizePublicPath(
    "D:\\Matize\\Matize-Kreation\\Matize-Musik\\public\\audio\\facetten\\3 - Perspektive_(Master).mp3"
  );
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[280px,1fr] items-start">
          <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-slate-700/40 bg-slate-900/30">
            {cover ? <Image src={cover} alt="Perspektive" fill className="object-cover" priority /> : null}
          </div>

          <div className="space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.35em] text-slate-500 mb-2">Matize · Facetten</p>
              <h1 className="text-3xl font-semibold tracking-tight">Perspektive</h1>
            </div>
