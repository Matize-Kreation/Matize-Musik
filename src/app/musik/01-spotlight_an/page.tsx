...
export const metadata = { title: "Spotlight an | Matize-Musik" };

export default function TrackPage() {
  const cover = normalizePublicPath("public/images/covers/facetten/tracks/01-spotlight_an.jpg");
  const audio = normalizePublicPath("public/audio/facetten/1 - Spotlight_an_(Master).mp3");
